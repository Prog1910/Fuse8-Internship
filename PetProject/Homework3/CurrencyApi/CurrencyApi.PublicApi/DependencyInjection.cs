...
using CurrencyApi.PublicApi.Common.Mapping;
using CurrencyApi.PublicApi.Filters;
using Microsoft.OpenApi.Models;
using System.Text.Json.Serialization;

namespace CurrencyApi.PublicApi;
...
public static class DependencyInjection
{
	...
	{
		services.AddGrpcClient<CurrencyGrpc.CurrencyGrpcClient>(o => o.Address = new Uri(configuration["InternalApi:BaseUrl"] ?? "http://localhost:5000"))
