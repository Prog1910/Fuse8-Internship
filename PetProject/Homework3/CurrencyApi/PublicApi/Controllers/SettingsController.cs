...
public sealed class SettingsController : ControllerBase
{
	...
	public async Task<IActionResult> UpdateDefaultCurrency([FromQuery] CurrencyTypeDto defaultCurrency)
	{
		await _settingsService.UpdateDefaultCurrency((CurrencyType)defaultCurrency);
