...
public class CurrencyController : ControllerBase
{
	...
	{
		var currencyData = await _currencyService.GetCurrencyByDefault();
	...
	public async Task<IActionResult> GetHistoricalCurrencyByCode(string currencyCode, string date)
	{
