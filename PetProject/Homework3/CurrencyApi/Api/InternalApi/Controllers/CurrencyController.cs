...
public sealed class CurrencyController : ControllerBase
{
	...
	/// <summary>
	///     Gets the current currency exchange rate.
	/// </summary>
	...
	{
		var currencyDto = await _cacheCurrencyService.GetCurrentCurrencyAsync((Domain.Enums.CurrencyType)currencyCode, cancellationToken);

		return Ok(currencyDto.Adapt<CurrencyResponse>());
	}

	/// <summary>
	///     Gets the currency exchange rate for the specified date.
	/// </summary>
	/// <param name="currencyCode">The currency you want to get exchange rate.</param>
	...
	{
		var currencyDto = await _cacheCurrencyService.GetCurrencyOnDateAsync((Domain.Enums.CurrencyType)currencyCode, date, cancellationToken);
	...
	{
		var currencyDto = await _cacheCurrencyService.GetCurrencyByFavoritesAsync((Domain.Enums.CurrencyType)currencyCode, (Domain.Enums.CurrencyType)baseCurrencyCode, default, cancellationToken);

		return Ok(currencyDto.Adapt<CurrencyResponse>());
	}

	/// <summary>
	///     Gets the favorite currencies exchange rate for the specified date.
	/// </summary>
	/// <param name="currencyCode">The currency of favorite currencies you want to get exchange rate.</param>
	/// <param name="baseCurrencyCode">The base currency of favorite currencies.</param>
	...
	{
		var currencyDto = await _cacheCurrencyService.GetCurrencyByFavoritesAsync((Domain.Enums.CurrencyType)currencyCode, (Domain.Enums.CurrencyType)baseCurrencyCode, date, cancellationToken);
