...
/// <summary> Controller for managing favorite currencies. </summary>
[ApiController, Route("currency-api/favorites")]
public sealed class FavoritesController : ControllerBase
{
	...
	/// <summary> Retrieves a list of all favorite currencies </summary>
	...
	/// <summary> Retrieves the favorite currencies from cache </summary>
	...
	/// <response code="404"> The requested endpoint could not be found. </response>
	/// <response code="500"> An internal server error occurred while processing the request. </response>
	[HttpGet("{name}"), ProducesDefaultResponseType(typeof(FavoritesResponse))]
	public async Task<IActionResult> GetFavoritesByName([FromRoute] string name, CancellationToken cancellationToken)
	{
		FavoritesDto? favoriteCurrencyDto = await _favoritesService.GetFavoritesByNameAsync(name, cancellationToken);

		return Ok(favoriteCurrencyDto?.Adapt<FavoritesResponse>());
	}

	/// <summary> Adds the favorite currencies to cache </summary>
	...
	/// <response code="404"> The requested endpoint could not be found. </response>
	/// <response code="500"> An internal server error occurred while processing the request. </response>
	[HttpPost, ProducesDefaultResponseType(typeof(void))]
	...
	/// <summary> Updates the favorite currencies in cache by name </summary>
	...
	/// <summary> Deletes the favorite currencies from cache by name </summary>
	...
	/// <response code="404"> The requested endpoint could not be found. </response>
	/// <response code="500"> An internal server error occurred while processing the request. </response>
	[HttpDelete("{name}"), ProducesDefaultResponseType(typeof(void))]
