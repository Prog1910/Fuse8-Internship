...
namespace InternalApi.Infrastructure.Migrations
{
    ...
    [Migration("20230912183821_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InternalApi.Domain.Aggregates.CacheTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("InternalApi.Domain.Aggregates.CurrenciesOnDateCache", b =>
                {
            ...
            modelBuilder.Entity("InternalApi.Domain.Aggregates.CurrenciesOnDateCache", b =>
                {
                    b.OwnsMany("InternalApi.Domain.Aggregates.Currency", "Currencies", b1 =>
                        {
                            ...
                            b1.WithOwner()
                                ...
                                .HasConstraintName("fk_currency_currencies_on_dates_currencies_on_date_cache_last_");
                        });
